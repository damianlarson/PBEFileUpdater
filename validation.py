...
def parseBatter(player, battingattrs, fieldingattrs, header):
    if(int(player[31]) != int(TPEconverter[battingattrs.group('BABIPvsL')])):
        errs.append([header.group('playername'), 'BABIPvL', player[31], TPEconverter[battingattrs.group('BABIPvsL')]])
    ...
    if(int(player[37]) != int(TPEconverter[battingattrs.group('BABIPvsR')])):
        errs.append([header.group('playername'), 'BABIPvsR', player[37], TPEconverter[battingattrs.group('BABIPvsR')]])
        print(header.group('playername'), header.group('position'),"BABIP vs R diff: ", player[37], " ", TPEconverter[battingattrs.group('BABIPvsR')])
    if(int(player[43]) != int(TPEconverter[min(battingattrs.group('BABIPvsL'), battingattrs.group('BABIPvsR'))])):
        errs.append([header.group('playername'), 'BABIPPot', player[43], TPEconverter[min(battingattrs.group('BABIPvsL'), battingattrs.group('BABIPvsR'))]])
        print(header.group('playername'), header.group('position'),"BABIP POT diff: ", player[43], " ", TPEconverter[min(battingattrs.group('BABIPvsL'), battingattrs.group('BABIPvsR'))])
    if(int(player[30]) != int(TPEconverter[battingattrs.group('AvoidvsL')])):
        errs.append([header.group('playername'), 'AvoidvsL', player[30], TPEconverter[battingattrs.group('AvoidvsL')]])
    ...
    if(int(player[36]) != int(TPEconverter[battingattrs.group('AvoidvsR')])):
        errs.append([header.group('playername'), 'AvoidvsR', player[36], TPEconverter[battingattrs.group('AvoidvsR')]])
    ...
    if(int(player[42]) != int(TPEconverter[min(battingattrs.group('AvoidvsL'), battingattrs.group('AvoidvsR'))])):
        errs.append([header.group('playername'), 'AvoidKPot', player[42], TPEconverter[min(battingattrs.group('AvoidvsL'), battingattrs.group('AvoidvsR'))]])
        print(header.group('playername'), header.group('position'),"Avoid POT K's diff: ", player[42], " ", TPEconverter[min(battingattrs.group('AvoidvsL'), battingattrs.group('AvoidvsR'))])
    if(int(player[27]) != int(TPEconverter[battingattrs.group('GapvsL')])):
        errs.append([header.group('playername'), 'GapvsL', player[27], TPEconverter[battingattrs.group('GapvsL')]])
    ...
    if(int(player[33]) != int(TPEconverter[battingattrs.group('GapvsR')])):
        errs.append([header.group('playername'), 'GapvsR', player[33], TPEconverter[battingattrs.group('GapvsR')]])
        print(header.group('playername'), header.group('position'),"Gap vs R diff: ", player[33], " ", TPEconverter[battingattrs.group('GapvsR')])
    if(int(player[39]) != int(TPEconverter[min(battingattrs.group('GapvsL'), battingattrs.group('GapvsR'))])):
        errs.append([header.group('playername'), 'GapPot', player[39], TPEconverter[min(battingattrs.group('GapvsL'), battingattrs.group('GapvsR'))]])
        print(header.group('playername'), header.group('position'),"Gap POT diff: ", player[39], " ", TPEconverter[min(battingattrs.group('GapvsL'), battingattrs.group('GapvsR'))])
    if(int(player[28]) != int(TPEconverter[battingattrs.group('PowervsL')])):
        errs.append([header.group('playername'), 'PowervsL', player[28], TPEconverter[battingattrs.group('PowervsL')]])
    ...
    if(int(player[34]) != int(TPEconverter[battingattrs.group('PowervsR')])):
        errs.append([header.group('playername'), 'PowervsR', player[34], TPEconverter[battingattrs.group('PowervsR')]])
        print(header.group('playername'), header.group('position'),"Power vs R diff: ", player[34], " ", TPEconverter[battingattrs.group('PowervsR')])
    if(int(player[40]) != int(TPEconverter[min(battingattrs.group('PowervsL'), battingattrs.group('PowervsR'))])):
        errs.append([header.group('playername'), 'PowerPot', player[40], TPEconverter[min(battingattrs.group('PowervsL'), battingattrs.group('PowervsR'))]])
        print(header.group('playername'), header.group('position'),"Power POT diff: ", player[40], " ", TPEconverter[min(battingattrs.group('PowervsL'), battingattrs.group('PowervsR'))])
    if(int(player[29]) != int(TPEconverter[battingattrs.group('EyevsL')])):
        errs.append([header.group('playername'), 'EyevsL', player[29], TPEconverter[battingattrs.group('EyevsL')]])
    ...
    if(int(player[35]) != int(TPEconverter[battingattrs.group('EyevsR')])):
        errs.append([header.group('playername'), 'EyevsR', player[35], TPEconverter[battingattrs.group('EyevsR')]])
        print(header.group('playername'), header.group('position'),"Eye vs R diff: ", player[35], " ", TPEconverter[battingattrs.group('EyevsR')])
    if(int(player[41]) != int(TPEconverter[min(battingattrs.group('EyevsL'), battingattrs.group('EyevsR'))])):
        errs.append([header.group('playername'), 'EyePot', player[41], TPEconverter[min(battingattrs.group('EyevsL'), battingattrs.group('EyevsR'))]])
        print(header.group('playername'), header.group('position'),"Eye POT diff: ", player[41], " ", TPEconverter[min(battingattrs.group('EyevsL'), battingattrs.group('EyevsR'))])
    if(int(player[47]) != (int(battingattrs.group('Speed'))*2)):
        errs.append([header.group('playername'), 'Speed', player[47], int(battingattrs.group('Speed'))*2])
    ...
    if(int(player[50]) != (int(battingattrs.group('Speed'))*2)):
        errs.append([header.group('playername'), 'Speed', player[50], int(battingattrs.group('Speed'))*2])
    ...
    if(int(player[48]) != (int(battingattrs.group('Stealing'))*2)):
        errs.append([header.group('playername'), 'Stealing', player[48], int(battingattrs.group('Stealing'))*2])
    ...
    if(int(player[49]) != (int(battingattrs.group('Stealing'))*2)):
        errs.append([header.group('playername'), 'Stealing', player[49], int(battingattrs.group('Stealing'))*2])
    ...
    if(int(player[67]) != (int(fieldingattrs.group('Range'))*2)):
        errs.append([header.group('playername'), 'Range', player[67], int(fieldingattrs.group('Range'))*2])
    ...
    if(int(player[73]) != (int(fieldingattrs.group('Range'))*2)):
        errs.append([header.group('playername'), 'Range', player[73], int(fieldingattrs.group('Range'))*2])
    ...
    if(int(player[68]) != (int(fieldingattrs.group('Error'))*2)):
        errs.append([header.group('playername'), 'Error', player[68], int(fieldingattrs.group('Error'))*2])
    ...
    if(int(player[74]) != (int(fieldingattrs.group('Error'))*2)):
        errs.append([header.group('playername'), 'Error', player[74], int(fieldingattrs.group('Error'))*2])
    ...
    if(int(player[69]) != (int(fieldingattrs.group('Arm'))*2)):
        errs.append([header.group('playername'), 'Arm', player[69], int(fieldingattrs.group('Arm'))*2])
    ...
    if(int(player[75]) != (int(fieldingattrs.group('Arm'))*2)):
        errs.append([header.group('playername'), 'Arm', player[75], int(fieldingattrs.group('Arm'))*2])
    ...
    if(int(player[72]) != (int(fieldingattrs.group('Arm'))*2)):
        errs.append([header.group('playername'), 'Arm', player[72], int(fieldingattrs.group('Arm'))*2])
    ...
    if(int(player[70]) != (int(fieldingattrs.group('DP'))*2)):
        errs.append([header.group('playername'), 'DP', player[70], int(fieldingattrs.group('DP'))*2])
        print(header.group('playername'), header.group('position'),"DP diff: ", player[70], " ", int(fieldingattrs.group('DP'))*2)
    if (fieldingattrs.group('CABL') != None):
        if(int(player[71]) != (int(fieldingattrs.group('CABL'))*2)):
            errs.append([header.group('playername'), 'CatcherBlock', player[71], int(fieldingattrs.group('CABL'))*2])
            print(header.group('playername'), header.group('position'),"Catcher Blocking diff: ", player[71], " ", int(fieldingattrs.group('CABL'))*2)


    #temporary framing
    if (fieldingattrs.group('CAF') != None):
        if(int(player[155]) != (int(fieldingattrs.group('CAF'))*2)):
            errs.append([header.group('playername'), 'CatcherFrame', player[155], int(fieldingattrs.group('CAF'))*2])
            print(header.group('playername'), header.group('position'),"Catcher Framing diff: ", player[155], " ", int(fieldingattrs.group('CAF'))*2)
...
def parsePitcher(player, row, header):
    ...
    if(int(player[65]) != VelocityConverter[velocity.group('Velocity').strip()]):
        errs.append([header.group('playername'), 'Velocity', player[65], VelocityConverter[velocity.group('Velocity').strip()]])
    ...
    if(int(player[156]) != VelocityConverter[velocity.group('Velocity').strip()]):
        errs.append([header.group('playername'), 'VelocityPot', player[156], VelocityConverter[velocity.group('Velocity').strip()]])
    ...
    if(int(player[53]) != TPEconverter[pitchingattrs.group('MovesvsL')]):
        errs.append([header.group('playername'), 'MovesvsL', player[53], TPEconverter[pitchingattrs.group('MovesvsL')]])
    ...
    if(int(player[55]) != TPEconverter[pitchingattrs.group('MovesvsR')]):
        errs.append([header.group('playername'), 'MovesvsR', player[55], TPEconverter[pitchingattrs.group('MovesvsR')]])
        print(header.group('playername'), header.group('position'),"Moves vs R diff: ", player[55], " ", TPEconverter[pitchingattrs.group('MovesvsR')])
    if(int(player[57]) != TPEconverter[min(pitchingattrs.group('MovesvsL'), pitchingattrs.group('MovesvsR'))]):
        errs.append([header.group('playername'), 'MovesPOT', player[57], TPEconverter[min(pitchingattrs.group('MovesvsL'), pitchingattrs.group('MovesvsR'))]])
        print(header.group('playername'), header.group('position'),"Moves POT diff: ", player[57], " ", TPEconverter[min(pitchingattrs.group('MovesvsL'), pitchingattrs.group('MovesvsR'))])
    if(int(player[54]) != TPEconverter[pitchingattrs.group('ControlvsL')]):
        errs.append([header.group('playername'), 'ControlvsL', player[54], TPEconverter[pitchingattrs.group('ControlvsL')]])
    ...
    if(int(player[56]) != TPEconverter[pitchingattrs.group('ControlvsR')]):
        errs.append([header.group('playername'), 'ControlvsR', player[56], TPEconverter[pitchingattrs.group('ControlvsR')]])
    ...
    if(int(player[58]) != TPEconverter[min(pitchingattrs.group('ControlvsL'), pitchingattrs.group('ControlvsR'))]):
        errs.append([header.group('playername'), 'ControlPOT', player[58], TPEconverter[min(pitchingattrs.group('ControlvsL'), pitchingattrs.group('ControlvsR'))]])
        print(header.group('playername'), header.group('position'),"Control POT diff: ", player[58], " ", TPEconverter[min(pitchingattrs.group('ControlvsL'), pitchingattrs.group('ControlvsR'))])
    if(pBABIP != None):
        if(int(player[150]) != int(pBABIP.group('pBABIP'))*2):
            errs.append([header.group('playername'), 'pBABIP', player[150], int(pitchingattrs.group('pBABIP'))*2])
    ...
    if(int(player[62]) != (int(pitchingattrs.group('Stamina'))*2)):
        errs.append([header.group('playername'), 'Stamina', player[62], int(pitchingattrs.group('Stamina'))*2])
    ...
    if(int(player[63]) != (int(pitchingattrs.group('Hold'))*2)):
        errs.append([header.group('playername'), 'Hold', player[63], int(pitchingattrs.group('Hold'))*2])
    ...
    if(player[64] != pitchingattrs.group('GB')):
        errs.append([header.group('playername'), 'GB', player[64], pitchingattrs.group('GB')])
        print(header.group('playername'), header.group('position'),"GB diff: ", player[64], " ", pitchingattrs.group('GB'))
    if(float(player[123]) != float(1)):
        errs.append([header.group('playername'), 'L/R Split', player[123], 1])
    ...
    if fastball != None and (int(player[125]) != TPEconverter[fastball.group('Fastball')]):
        errs.append([header.group('playername'), 'Fastball', player[125], TPEconverter[fastball.group('Fastball')]])
    ...
    if fastball != None and (int(player[137]) != TPEconverter[fastball.group('Fastball')]):
        errs.append([header.group('playername'), 'Fastball Pot', player[137], TPEconverter[fastball.group('Fastball')]])
    ...
    if slider != None and int(player[126]) != TPEconverter[slider.group('Slider')]:
        errs.append([header.group('playername'), 'Slider', player[126], TPEconverter[slider.group('Slider')]])
    ...
    if slider != None and int(player[138]) != TPEconverter[slider.group('Slider')]:
        errs.append([header.group('playername'), 'Slider Pot', player[138], TPEconverter[slider.group('Slider')]])
    ...
    if curveball != None and int(player[127]) != TPEconverter[curveball.group('Curveball')]:
        errs.append([header.group('playername'), 'Curveball', player[127], TPEconverter[curveball.group('Curveball')]])
    ...
    if curveball != None and int(player[139]) != TPEconverter[curveball.group('Curveball')]:
        errs.append([header.group('playername'), 'Curveball Pot', player[139], TPEconverter[curveball.group('Curveball')]])
    ...
    if changeup != None and int(player[128]) != TPEconverter[changeup.group('Changeup')]:
        errs.append([header.group('playername'), 'Changeup', player[128], TPEconverter[changeup.group('Changeup')]])
    ...
    if changeup != None and int(player[140]) != TPEconverter[changeup.group('Changeup')]:
        errs.append([header.group('playername'), 'Changeup Pot', player[140], TPEconverter[changeup.group('Changeup')]])
    ...
    if cutter != None and (int(player[129]) != TPEconverter[cutter.group('Cutter')]):
        errs.append([header.group('playername'), 'Cutter', player[129], TPEconverter[cutter.group('Cutter')]])
    ...
    if cutter != None and (int(player[141]) != TPEconverter[cutter.group('Cutter')]):
        errs.append([header.group('playername'), 'Cutter Pot', player[141], TPEconverter[cutter.group('Cutter')]])
    ...
    if sinker != None and (int(player[130]) != TPEconverter[sinker.group('Sinker')]):
        errs.append([header.group('playername'), 'Sinker', player[130], TPEconverter[sinker.group('Sinker')]])
    ...
    if sinker != None and (int(player[142]) != TPEconverter[sinker.group('Sinker')]):
        errs.append([header.group('playername'), 'Sinker Pot', player[142], TPEconverter[sinker.group('Sinker')]])
    ...
    if splitter != None and (int(player[131]) != TPEconverter[splitter.group('Splitter')]):
        errs.append([header.group('playername'), 'Splitter', player[131], TPEconverter[splitter.group('Splitter')]])
    ...
    if splitter != None and (int(player[143]) != TPEconverter[splitter.group('Splitter')]):
        errs.append([header.group('playername'), 'Splitter Pot', player[143], TPEconverter[splitter.group('Splitter')]])
    ...
    if forkball != None:
        if(int(player[132]) != TPEconverter[forkball.group('Forkball')]):
            errs.append([header.group('playername'), 'Forkball', player[132], TPEconverter[forkball.group('Forkball')]])
        ...
        if(int(player[144]) != TPEconverter[forkball.group('Forkball')]):
            errs.append([header.group('playername'), 'Forkball Pot', player[144], TPEconverter[forkball.group('Forkball')]])
    ...
    if screwball != None and (int(player[133]) != TPEconverter[screwball.group('Screwball')]):
        errs.append([header.group('playername'), 'Screwball', player[133], TPEconverter[screwball.group('Screwball')]])
    ...
    if screwball != None and (int(player[145]) != TPEconverter[screwball.group('Screwball')]):
        errs.append([header.group('playername'), 'Screwball Pot', player[145], TPEconverter[screwball.group('Screwball')]])
    ...
    if circlechange != None and (int(player[134]) != TPEconverter[circlechange.group('Circlechange')]):
        errs.append([header.group('playername'), 'Circlechange', player[134], TPEconverter[circlechange.group('Circlechange')]])
    ...
    if circlechange != None and (int(player[146]) != TPEconverter[circlechange.group('Circlechange')]):
        errs.append([header.group('playername'), 'Circlechange Pot', player[146], TPEconverter[circlechange.group('Circlechange')]])
    ...
    if knucklecurve != None and (int(player[135]) != TPEconverter[knucklecurve.group('Knucklecurve')]):
        errs.append([header.group('playername'), 'Knucklecurve', player[135], TPEconverter[knucklecurve.group('Knucklecurve')]])
    ...
    if knucklecurve != None and (int(player[147]) != TPEconverter[knucklecurve.group('Knucklecurve')]):
        errs.append([header.group('playername'), 'Knucklecurve Pot', player[147], TPEconverter[knucklecurve.group('Knucklecurve')]])
        ...
        if(counter != 0):
            ...
            if(header != None):
                if(header.group('position') != "SP" and header.group('position') != "RP"):
                    ...
                    if (battingattrs == None or fieldingattrs == None):
                        continue
...
with open('./errors/errors.csv', 'w', newline='', encoding="UTF-8") as outputcsvfile:
