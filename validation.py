...
def parseBatter(player, battingattrs, fieldingattrs, header):
    if(int(player[31]) != int(TPEconverter[battingattrs.group('BABIPvsL')])):
        batterErrs.append([header.group('playername'), 'BABIPvL', player[31], TPEconverter[battingattrs.group('BABIPvsL')]])
    ...
    if(int(player[37]) != int(TPEconverter[battingattrs.group('BABIPvsR')])):
        batterErrs.append([header.group('playername'), 'BABIPvsR', player[37], TPEconverter[battingattrs.group('BABIPvsR')]])
    ...
    if(int(player[43]) != int(TPEconverter[min(battingattrs.group('BABIPvsL'), battingattrs.group('BABIPvsR'))])):
        batterErrs.append([header.group('playername'), 'BABIPPot', player[43], TPEconverter[min(battingattrs.group('BABIPvsL'), battingattrs.group('BABIPvsR'))]])
    ...
    if(int(player[30]) != int(TPEconverter[battingattrs.group('AvoidvsL')])):
        batterErrs.append([header.group('playername'), 'AvoidvsL', player[30], TPEconverter[battingattrs.group('AvoidvsL')]])
    ...
    if(int(player[36]) != int(TPEconverter[battingattrs.group('AvoidvsR')])):
        batterErrs.append([header.group('playername'), 'AvoidvsR', player[36], TPEconverter[battingattrs.group('AvoidvsR')]])
    ...
    if(int(player[42]) != int(TPEconverter[min(battingattrs.group('AvoidvsL'), battingattrs.group('AvoidvsR'))])):
        batterErrs.append([header.group('playername'), 'AvoidKPot', player[42], TPEconverter[min(battingattrs.group('AvoidvsL'), battingattrs.group('AvoidvsR'))]])
    ...
    if(int(player[27]) != int(TPEconverter[battingattrs.group('GapvsL')])):
        batterErrs.append([header.group('playername'), 'GapvsL', player[27], TPEconverter[battingattrs.group('GapvsL')]])
    ...
    if(int(player[33]) != int(TPEconverter[battingattrs.group('GapvsR')])):
        batterErrs.append([header.group('playername'), 'GapvsR', player[33], TPEconverter[battingattrs.group('GapvsR')]])
    ...
    if(int(player[39]) != int(TPEconverter[min(battingattrs.group('GapvsL'), battingattrs.group('GapvsR'))])):
        batterErrs.append([header.group('playername'), 'GapPot', player[39], TPEconverter[min(battingattrs.group('GapvsL'), battingattrs.group('GapvsR'))]])
    ...
    if(int(player[28]) != int(TPEconverter[battingattrs.group('PowervsL')])):
        batterErrs.append([header.group('playername'), 'PowervsL', player[28], TPEconverter[battingattrs.group('PowervsL')]])
    ...
    if(int(player[34]) != int(TPEconverter[battingattrs.group('PowervsR')])):
        batterErrs.append([header.group('playername'), 'PowervsR', player[34], TPEconverter[battingattrs.group('PowervsR')]])
    ...
    if(int(player[40]) != int(TPEconverter[min(battingattrs.group('PowervsL'), battingattrs.group('PowervsR'))])):
        batterErrs.append([header.group('playername'), 'PowerPot', player[40], TPEconverter[min(battingattrs.group('PowervsL'), battingattrs.group('PowervsR'))]])
    ...
    if(int(player[29]) != int(TPEconverter[battingattrs.group('EyevsL')])):
        batterErrs.append([header.group('playername'), 'EyevsL', player[29], TPEconverter[battingattrs.group('EyevsL')]])
    ...
    if(int(player[35]) != int(TPEconverter[battingattrs.group('EyevsR')])):
        batterErrs.append([header.group('playername'), 'EyevsR', player[35], TPEconverter[battingattrs.group('EyevsR')]])
    ...
    if(int(player[41]) != int(TPEconverter[min(battingattrs.group('EyevsL'), battingattrs.group('EyevsR'))])):
        batterErrs.append([header.group('playername'), 'EyePot', player[41], TPEconverter[min(battingattrs.group('EyevsL'), battingattrs.group('EyevsR'))]])
    ...
    if(int(player[47]) != (int(battingattrs.group('Speed'))*2)):
        batterErrs.append([header.group('playername'), 'Speed', player[47], int(battingattrs.group('Speed'))*2])
    ...
    if(int(player[50]) != (int(battingattrs.group('Speed'))*2)):
        batterErrs.append([header.group('playername'), 'Speed', player[50], int(battingattrs.group('Speed'))*2])
    ...
    if(int(player[48]) != (int(battingattrs.group('Stealing'))*2)):
        batterErrs.append([header.group('playername'), 'Stealing', player[48], int(battingattrs.group('Stealing'))*2])
    ...
    if(int(player[49]) != (int(battingattrs.group('Stealing'))*2)):
        batterErrs.append([header.group('playername'), 'Stealing', player[49], int(battingattrs.group('Stealing'))*2])
    ...
    if(int(player[67]) != (int(fieldingattrs.group('Range'))*2)):
        batterErrs.append([header.group('playername'), 'Range', player[67], int(fieldingattrs.group('Range'))*2])
    ...
    if(int(player[73]) != (int(fieldingattrs.group('Range'))*2)):
        batterErrs.append([header.group('playername'), 'Range', player[73], int(fieldingattrs.group('Range'))*2])
    ...
    if(int(player[68]) != (int(fieldingattrs.group('Error'))*2)):
        batterErrs.append([header.group('playername'), 'Error', player[68], int(fieldingattrs.group('Error'))*2])
    ...
    if(int(player[74]) != (int(fieldingattrs.group('Error'))*2)):
        batterErrs.append([header.group('playername'), 'Error', player[74], int(fieldingattrs.group('Error'))*2])
    ...
    if(int(player[69]) != (int(fieldingattrs.group('Arm'))*2)):
        batterErrs.append([header.group('playername'), 'Arm', player[69], int(fieldingattrs.group('Arm'))*2])
    ...
    if(int(player[75]) != (int(fieldingattrs.group('Arm'))*2)):
        batterErrs.append([header.group('playername'), 'Arm', player[75], int(fieldingattrs.group('Arm'))*2])
    ...
    if(int(player[72]) != (int(fieldingattrs.group('Arm'))*2)):
        batterErrs.append([header.group('playername'), 'Arm', player[72], int(fieldingattrs.group('Arm'))*2])
    ...
    if(int(player[70]) != (int(fieldingattrs.group('DP'))*2)):
        batterErrs.append([header.group('playername'), 'DP', player[70], int(fieldingattrs.group('DP'))*2])
    ...
    if (fieldingattrs.group('CABL') != None):
        if(int(player[71]) != (int(fieldingattrs.group('CABL'))*2)):
            batterErrs.append([header.group('playername'), 'CatcherBlock', player[71], int(fieldingattrs.group('CABL'))*2])
    ...
    if (fieldingattrs.group('CAF') != None):
        if(int(player[155]) != (int(fieldingattrs.group('CAF'))*2)):
            batterErrs.append([header.group('playername'), 'CatcherFrame', player[155], int(fieldingattrs.group('CAF'))*2])
